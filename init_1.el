...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(vscode-dark-plus-theme use-package py-autopep8 modern-cpp-font-lock material-theme magit iedit google-c-style format-all flymake-cursor flycheck-google-cpplint elpy ein clang-format blacken better-defaults auto-complete-c-headers auto-complete-auctex auctex ac-math))))
(custom-set-faces
