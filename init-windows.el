...
;; Autofomat the code using elpy-black
(add-hook 'elpy-mode-hook (lambda ()
                            (add-hook 'before-save-hook
                                      'elpy-black-fix-code nil t)))

;; From elpy use ipython
...
(setq ispell-hunspell-dict-paths-alist '(("en_US" "C:/Users/1370354/AppData/Roaming/hunspell/en_US.aff"))
      )
...
;; Org notes into logbook entries
